...
const ContactForm: React.FC = () => {
    ...
    const contactInfo = [
        ...
        },
        {
            icon: MapPin,
            label: "Location",
            value: `${profile.basics.location.city}, ${profile.basics.location.state}`,
            href: "#",
        },
    ];
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-8">
                                ...
                                opportunities, creative projects, or potential
                                collaborations. Feel free to reach out through
